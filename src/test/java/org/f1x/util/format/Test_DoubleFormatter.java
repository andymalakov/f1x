...
public class Test_DoubleFormatter {
    ...
    private static void assertFormat(DoubleFormatter df, double number, DecimalFormat standardFormat) {
...
//        assertEquals (expected, actual);
    ...
    private static void assertFormat(double number, String expected, int precision) {
        DoubleFormatter df = new DoubleFormatter(precision);
        byte [] buffer= new byte[MAX_WIDTH];
        int length = df.format(number, buffer, 0);
    ...
    public void testEnum() {
        ...
        DoubleFormatter df = new DoubleFormatter(2);
        ...
        while (number < -0.01) {
            assertFormat(df, number, standardFormat);
            number = number / 10;
        }
    ...
    public void testRandom() {
        ...
        DoubleFormatter df = new DoubleFormatter(5);
        DecimalFormat standardFormat = new DecimalFormat("###.#####");
        standardFormat.setRoundingMode(RoundingMode.HALF_UP);
    ...
    @Test
    @Ignore //TODO: Known rounding problem
    public void testBug1() {
        DoubleFormatter df = new DoubleFormatter(2);
        DecimalFormat standardFormat = new DecimalFormat("###.##");
        standardFormat.setRoundingMode(RoundingMode.HALF_UP);
        assertEquals("standardFormat", "49405.99", standardFormat.format(49405.994999999995));
        assertFormat(df, 49405.994999999995, standardFormat);
    }
