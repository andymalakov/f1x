...
public class RollingFileMessageLog extends PeriodicFlushingMessageLog {
     ...
     * @param sessionID
     * @param timeSource
     * @param bytesPerFile This setting defines maximum size of each log file.
     ...
     */
    public RollingFileMessageLog(OutputStreamFactory outputStreamFactory, SessionID sessionID, TimeSource timeSource, long bytesPerFile, int flushPeriod) {
