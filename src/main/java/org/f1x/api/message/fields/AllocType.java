...
public enum AllocType implements org.f1x.api.message.types.ByteEnum {
	CALCULATED((byte)'1'),
	PRELIMINARY((byte)'2'),
	READY_TO_BOOK_SINGLE_ORDER((byte)'5'),
	WAREHOUSE_INSTRUCTION((byte)'7'),
	...
	public static AllocType parse(String s) {
		switch(s) {
