...
public enum MassCancelResponse implements org.f1x.api.message.types.ByteEnum {
	CANCEL_REQUEST_REJECTED((byte)'0'),
	...
	MassCancelResponse (byte code) {
		this.code  = code;
	}

	public byte getCode() { return code; }

	public static MassCancelResponse parse(String s) {
		switch(s) {
